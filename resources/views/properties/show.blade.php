...
<x-app-layout>
    ...
    <main class="w-full h-full pt-32 text-black bg-gray-300">
        <div class="flex flex-col items-center justify-center w-full h-full">
            ...
            <div id="show-information-section" class="h-full rounded-[10px] flex justify-center items-stretch py-4 gap-4">
                ...
                <div id="property-info" class="flex flex-col items-center justify-center flex-1">
                    ...
                    <div class="flex flex-col items-center justify-center w-full gap-4 pb-2">
                        <div class="px-5 py-5 w-full h-full flex flex-col justify-center items-center bg-[#8E8A8D] bg-opacity-20 rounded-[5px]">
                    ...
                    <div class="flex flex-col items-center justify-center w-full gap-4 pb-2">
                        <div class="px-5 py-4 w-full h-full flex flex-col justify-center items-center bg-[#8E8A8D] rounded-[5px] bg-opacity-20">
                            <!-- Section title -->
                            ...
                            <div id="basic-property-details">
                                ...
                                <div id="basic-details-first-row">
                                    ...
                                    <div class="w-[33%] justify-start items-center">
                                        <x-property-detail icon='govicon-construction' title="Year&nbsp;built" :text="$property->year_built" unit="" css='w-[48px] h-[48px]' />
                                    </div>
                                ...
                                <div id="basic-details-second-row">
                                    <div class="w-[33%] justify-start items-center">
                                        <x-property-detail icon='maki-furniture' title="Furnished" :text="$furnished" unit="" css='w-[48px] h-[48px]' />
                                    </div>

                                    <div class="w-[33%] justify-start items-center">
                                        <x-property-detail icon='phosphor-security-camera-duotone' title="Intercom" :text="$video" unit="" css='w-[46px] h-[48px]' />
                                    </div>

                                    <div class="w-[33%] justify-center items-center">
                                        @if (!is_null($property->lease_duration) && $property->lease_duration !== 0 )
                                            <x-property-detail icon='ionicon-calendar' title="Lease" text="Yes" unit="" css='w-[46px] h-[48px]' />
                                        @else
                                            <x-property-detail icon='ionicon-calendar' title="Lease" text="No" unit="" css='w-[46px] h-[48px]' />
                                        @endif
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="w-full h-full flex flex-col justify-center items-center rounded-[5px] px-5 py-4 bg-[#8E8A8D] bg-opacity-20">
                ...
                <div id="agent-info" class="w-[35%]">
                    <div id="sticky" class="flex flex-col items-center justify-center mb-auto">
                        <!-- Other property data -->
                        <div class="mb-[10px] h-[100px] w-full bg-[#8E8A8D] bg-opacity-20 rounded-[5px] flex flex-col py-5 px-5 justify-center items-center">
                            <!-- Property price -->
                            <div class="rounded-[5px] flex justify-start items-center pb-4 w-full">
                        ...
                        <!-- Agent data -->
                        <div id="" class="w-full flex mb-auto flex-col justify-center items-center bg-[#8E8A8D] bg-opacity-20 py-5 px-5 rounded-[5px]">
                            <!-- Section header -->
                            <div class="mr-auto text-xl font-bold">
                                <p>Contact Us</p>
                            </div>
            ...
            <!-- Similar properties -->
            <div id="similar-properties" class="h-full bg-[#8E8A8D] bg-opacity-20 w-[80%] mb-8 rounded-[10px] p-5 flex flex-col justify-center items-center">
                <div class="pb-4 mr-auto text-2xl font-bold">
                ...
                <div id="similar-properties-list" class="flex items-center justify-center w-full gap-4 sm:gap-[2%]">
                    @foreach ($similarProperties as $property )
                        <div wire:key="{{ $property['id'] }}" class="w-full lg:!w-[32%] {{ $loop->last ? 'mr-auto' : '' }}">
                            <a href="{{ route('single-property', ['id' => $property->id]) }}" class=" {{ $loop->last ? 'mr-auto' : '' }}">
