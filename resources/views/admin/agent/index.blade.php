    ...
    <div class="flex flex-col min-h-screen bg-gray-900">
        ...
        <div class="flex w-full pt-[100px]">
            ...
            <div id="main-content" class="w-full pt-6 bg-gray-900">
                <div id="sessionMessage" class="px-[12%] flex justify-center items-center">
                    @if (session('success'))
                        <div id="sessionMessage" class="relative p-4 text-white bg-green-500 rounded-md w-[400px] justify-center items-center" >
                            <span class="absolute flex items-center justify-center px-[9px] py-0 text-base text-white bg-green-700 rounded-full cursor-pointer top-1 right-1 text-center" onclick="closeSessionMessageMobile()">&times;</span>
                    ...
                    @if (session('error'))
                        <div id="sessionMessage" class="relative p-4 text-white bg-red-500 rounded-md w-[400px] justify-center items-center px-auto" >
                            <span class="absolute flex items-center justify-center px-[10px] py-0 text-base text-white bg-red-700 rounded-full cursor-pointer top-1 right-1 text-center" onclick="closeSessionMessageMobile()">&times;</span>
