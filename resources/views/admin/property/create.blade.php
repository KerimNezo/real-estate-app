                            ...
                            <div class="flex w-full">
                                ...
                                <div class="w-[500px]">
                                    ...
                                    <div class="mb-4 mr-auto">
                                        ...
                                        <input type="text" name="name" id="name" value="{{ old('name', $property->name) }}" class="w-full px-3 py-2 border rounded-lg bg-gray-800 @error('name') border-red-500 @enderror">
                                        @error('name')
